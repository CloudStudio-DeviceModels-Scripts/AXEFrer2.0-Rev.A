...
# Parsing + Configuration Script – AXE Frer 2.0 - Rev. A

This **Parsing + Configuration** script is designed for the **AXE Frer 2.0** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AXE Frer 2.0 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AXE Frer 2.0** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
